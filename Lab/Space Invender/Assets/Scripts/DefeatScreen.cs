...
/// <summary>
/// Monta a cena de derrota automaticamente.
/// Anexe este script a um GameObject vazio na cena Defeat.
/// </summary>
public class DefeatScreen : MonoBehaviour
{
    private void Start()
    {
        ...
        // Título
        CreateText(canvasGo, "GAME OVER", 72, Color.red, new Vector2(0, 100));
